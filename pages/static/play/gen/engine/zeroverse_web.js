...
export class WebWorld {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WebWorldFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_webworld_free(ptr, 0);
    }
    /**
     ...
     */
    setDecider(f) {
        wasm.webworld_setDecider(this.__wbg_ptr, f);
    }
    /**
    ...
    constructor(seed, setup) {
        const ret = wasm.webworld_new(seed, setup);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        WebWorldFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    step(months) {
        wasm.webworld_step(this.__wbg_ptr, months);
    }
    /**
     * @returns {number}
     */
    alive() {
        const ret = wasm.webworld_alive(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    month() {
        const ret = wasm.webworld_month(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    state() {
        const ret = wasm.webworld_state(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    report() {
        const ret = wasm.webworld_report(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('zeroverse_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
