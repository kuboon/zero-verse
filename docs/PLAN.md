...
- **キャンペーンモード**（[world.md](./design/world.md)）：時代・地域シナリオ + クリア条件。M1〜M4 の検証シナリオ（交易・貨幣・教育・血縁）をそのまま最初のキャンペーン群に転用する。NPC brain セットとクリア判定（複数シード成功率、未決 #9）はここで確定。
...
| 9 | キャンペーンのクリア判定（シード過学習対策） | **P5** | 複数シード成功率を第一候補に |
