...
- 板が薄い直接交換より、板の厚い resource を経由する間接交換が有利になり、正のフィードバックで一つの resource に収束する（メンガーの貨幣起源）。どれが選ばれるかは g 減衰率（貯蔵性）、**体積（携帯性・保管コスト → [02-resources.md](./02-resources.md)）**、分割可能性、需要の広さで決まる。**通貨を指名しない。**
